...
@Injectable()
export class StateKnowmyministerPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.stateModalRef(component, new StateKnowmyminister());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    stateModalRef(component: Component, state: StateKnowmyminister): NgbModalRef {
