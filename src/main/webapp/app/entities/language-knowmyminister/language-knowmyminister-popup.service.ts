...
@Injectable()
export class LanguageKnowmyministerPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.languageModalRef(component, new LanguageKnowmyminister());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    languageModalRef(component: Component, language: LanguageKnowmyminister): NgbModalRef {
