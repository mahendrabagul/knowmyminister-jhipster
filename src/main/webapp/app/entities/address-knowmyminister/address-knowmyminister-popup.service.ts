...
@Injectable()
export class AddressKnowmyministerPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.addressModalRef(component, new AddressKnowmyminister());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    addressModalRef(component: Component, address: AddressKnowmyminister): NgbModalRef {
