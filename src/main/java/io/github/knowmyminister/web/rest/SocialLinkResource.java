...
public class SocialLinkResource
{
	 ...
	 *
	 * @param socialLinkDTO
	 *            the socialLinkDTO to create
	 * @return the ResponseEntity with status 201 (Created) and with body the
	 *         new socialLinkDTO, or with status 400 (Bad Request) if the
	 *         socialLink has already an ID
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PostMapping("/social-links")
	@Timed
	public ResponseEntity<SocialLinkDTO> createSocialLink(@Valid @RequestBody SocialLinkDTO socialLinkDTO)
			throws URISyntaxException
	{
	 ...
	 *
	 * @param socialLinkDTO
	 *            the socialLinkDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         socialLinkDTO, or with status 400 (Bad Request) if the
	 *         socialLinkDTO is not valid, or with status 500 (Internal Server
	 *         Error) if the socialLinkDTO couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/social-links")
	@Timed
	public ResponseEntity<SocialLinkDTO> updateSocialLink(@Valid @RequestBody SocialLinkDTO socialLinkDTO)
			throws URISyntaxException
	{
	 ...
	 *
	 * @param id
	 *            the id of the socialLinkDTO to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         socialLinkDTO, or with status 404 (Not Found)
	 */
	 ...
	 *
	 * @param id
	 *            the id of the socialLinkDTO to delete
	...
	/**
	 * SEARCH /_search/social-links?query=:query : search for the socialLink
	 * corresponding to the query.
	 *
	 * @param query
	 *            the query of the socialLink search
