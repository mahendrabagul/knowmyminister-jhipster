...
{
	private static final long serialVersionUID = 2484808691109532153L;
	...
	public void setContryId(Long countryId)
	{
	...
	{
		return "AddressDTO{" + "id=" + getId() + ", line1='" + getLine1() + "'" + ", line2='" + getLine2() + "'"
				+ ", area='" + getArea() + "'" + ", pincode='" + getPincode() + "'" + ", village='" + getVillage() + "'"
				+ ", taluka='" + getTaluka() + "'" + ", city='" + getCity() + "'" + "}";
	}
}
