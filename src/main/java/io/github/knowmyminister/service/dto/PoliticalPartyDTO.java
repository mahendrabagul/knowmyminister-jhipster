...
public class PoliticalPartyDTO implements Serializable
{
	...
	private static final long serialVersionUID = 7808791662858509830L;
	...
	{
		return "PoliticalPartyDTO{" + "id=" + getId() + ", description='" + getDescription() + "'" + ", abbreviation='"
				+ getAbbreviation() + "'" + ", founded='" + getFounded() + "'" + ", precededBy='" + getPrecededBy()
				+ "'" + ", newsPaper='" + getNewsPaper() + "'" + ", youthWing='" + getYouthWing() + "'"
				+ ", womensWing='" + getWomensWing() + "'" + ", peasantsWing='" + getPeasantsWing() + "'"
				+ ", minorityWing='" + getMinorityWing() + "'" + ", membership='" + getMembership() + "'"
				+ ", ideology='" + getIdeology() + "'" + ", politicalPosition='" + getPoliticalPosition() + "'"
				+ ", internationalAffiliation='" + getInternationalAffiliation() + "'" + ", colour='" + getColour()
				+ "'" + ", eCIStatus='" + geteCIStatus() + "'" + ", alliance='" + getAlliance() + "'"
				+ ", seatsInLokSabha='" + getSeatsInLokSabha() + "'" + ", seatsInRajyaSabha='" + getSeatsInRajyaSabha()
				+ "'" + ", electionSymbol='" + getElectionSymbol() + "'" + ", website='" + getWebsite() + "'"
				+ ", parliamentaryChairperson='" + getParliamentaryChairperson() + "'" + ", email='" + getEmail() + "'"
				+ "}";
	}
}
