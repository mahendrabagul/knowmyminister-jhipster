...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "line1":"SAMPLE_TEXT", "line2":"SAMPLE_TEXT", "area":"SAMPLE_TEXT", "pincode":"SAMPLE_TEXT", "village":"SAMPLE_TEXT", "taluka":"SAMPLE_TEXT", "city":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
