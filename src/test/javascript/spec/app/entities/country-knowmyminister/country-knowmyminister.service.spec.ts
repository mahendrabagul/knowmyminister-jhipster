...
describe('Service Tests', () => {
    ...
    describe('CountryKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CountryKnowmyministerService);
        ...
        describe('Service methods', () => {
            ...
            it('should return CountryKnowmyminister', () => {

                let entity: CountryKnowmyminister;
                service.find(123).subscribe((_entity: CountryKnowmyminister) => {
                    entity = _entity;
                });
