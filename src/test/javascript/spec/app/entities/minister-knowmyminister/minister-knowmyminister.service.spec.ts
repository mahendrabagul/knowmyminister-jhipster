...
describe('Service Tests', () => {
    ...
    describe('MinisterKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MinisterKnowmyministerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ministers';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MinisterKnowmyminister', () => {

                let entity: MinisterKnowmyminister;
                service.find(123).subscribe((_entity: MinisterKnowmyminister) => {
                    entity = _entity;
                });
