...
describe('Service Tests', () => {
    ...
    describe('EducationKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EducationKnowmyministerService);
        ...
        describe('Service methods', () => {
            ...
            it('should return EducationKnowmyminister', () => {

                let entity: EducationKnowmyminister;
                service.find(123).subscribe((_entity: EducationKnowmyminister) => {
                    entity = _entity;
                });
