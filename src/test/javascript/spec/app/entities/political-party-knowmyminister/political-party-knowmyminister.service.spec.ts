...
describe('Service Tests', () => {
    ...
    describe('PoliticalPartyKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PoliticalPartyKnowmyministerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/political-parties';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PoliticalPartyKnowmyminister', () => {

                let entity: PoliticalPartyKnowmyminister;
                service.find(123).subscribe((_entity: PoliticalPartyKnowmyminister) => {
                    entity = _entity;
                });
