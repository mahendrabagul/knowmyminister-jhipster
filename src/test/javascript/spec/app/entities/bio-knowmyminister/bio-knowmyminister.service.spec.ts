...
describe('Service Tests', () => {
    ...
    describe('BioKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BioKnowmyministerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bios';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BioKnowmyminister', () => {

                let entity: BioKnowmyminister;
                service.find(123).subscribe((_entity: BioKnowmyminister) => {
                    entity = _entity;
                });
