...
describe('Service Tests', () => {
    ...
    describe('WorkExperienceKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WorkExperienceKnowmyministerService);
        ...
        describe('Service methods', () => {
            ...
            it('should return WorkExperienceKnowmyminister', () => {

                let entity: WorkExperienceKnowmyminister;
                service.find(123).subscribe((_entity: WorkExperienceKnowmyminister) => {
                    entity = _entity;
                });
