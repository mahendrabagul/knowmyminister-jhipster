...
describe('Service Tests', () => {
    ...
    describe('SocialLinkKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SocialLinkKnowmyministerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/social-links';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SocialLinkKnowmyminister', () => {

                let entity: SocialLinkKnowmyminister;
                service.find(123).subscribe((_entity: SocialLinkKnowmyminister) => {
                    entity = _entity;
                });
