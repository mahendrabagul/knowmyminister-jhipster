...
describe('Service Tests', () => {
    ...
    describe('AwardKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AwardKnowmyministerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/awards';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AwardKnowmyminister', () => {

                let entity: AwardKnowmyminister;
                service.find(123).subscribe((_entity: AwardKnowmyminister) => {
                    entity = _entity;
                });
