...
describe('Service Tests', () => {
    ...
    describe('StateKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(StateKnowmyministerService);
        ...
        describe('Service methods', () => {
            ...
            it('should return StateKnowmyminister', () => {

                let entity: StateKnowmyminister;
                service.find(123).subscribe((_entity: StateKnowmyminister) => {
                    entity = _entity;
                });
