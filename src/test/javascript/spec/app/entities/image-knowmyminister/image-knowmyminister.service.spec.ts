...
describe('Service Tests', () => {
    ...
    describe('ImageKnowmyminister Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ImageKnowmyministerService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ImageKnowmyminister', () => {

                let entity: ImageKnowmyminister;
                service.find(123).subscribe((_entity: ImageKnowmyminister) => {
                    entity = _entity;
                });
